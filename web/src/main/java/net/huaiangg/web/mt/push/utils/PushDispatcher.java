package net.huaiangg.web.mt.push.utils;
...
public class PushDispatcher {
    private static final String appId = "1CjBV6pLwz65hAxZiHSgw1";
    private static final String appKey = "hOmwjBSAmJ7wKGMaTJRu74";
    private static final String masterSecret = "cMMnRReUSi6enO085kAXwA";
